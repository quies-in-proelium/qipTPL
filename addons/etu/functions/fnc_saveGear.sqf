...
["write", [_unitID, "allGear", _allGear]] call GVAR(gearDB);
["write", [_unitID, "activeWeaponAndMuzzle", _activeWeaponAndMuzzle]] call GVAR(gearDB);
["write", [_unitID, "earplugs", _earplugs]] call GVAR(gearDB);
["write", [_unitID, "chestpack", _chestpack]] call GVAR(gearDB);
