...
if (_on) then {
    ...
    _trg setTriggerStatements [
        ...
        "ace_player setVariable ['cbrn_stoppedAutoDamage', true]; ace_player setVariable ['cbrn_damage', 0]; 'Success!' hintC 'The contamination stopped, it should have not come to this in the first place!'",
        ""
    ];
